...
public class Banca {
  ...
  public synchronized int getNumeroGanador() { return numeroGanador; }
  ...
  public synchronized int getNumeroRonda() { return numeroRonda; }

  // Método que se encarga de cambiar el número de la ronda
  public void siguienteRonda() { numeroRonda++; }
  
  // Método que se encarga de hacer ganar dinero a la banca
  public synchronized void bancaGano(int cantidad) { saldo += cantidad; }
  ...
  public boolean bancaIsBroke() { return 0 >= saldo; }

  // Método que informa de si la banca no puede pagar a un jugador
  public void bancaSinDineroSuficiente(String jugadorNombre) { System.out.println("La banca no tiene dinero suficiente para pagar a " + jugadorNombre); }

  // Método que termina el juego
  public void bancaPerdio() { System.out.println("La banca se ha quedado sin dinero, la banca perdió"); }
}
